...
import logo from '@/public/images/agrovoice-logo.png'
...
function IconLogo({ className, ...props }: React.ComponentProps<'img'>) {
  return (
    <img src={logo.src} className={cn('size-4', className)} alt="" {...props} />
  )
}
...
function IconGoogle({ className, ...props }: React.ComponentProps<'svg'>) {
  return <BsGoogle className={cn('size-4', className)} {...props} />
}
